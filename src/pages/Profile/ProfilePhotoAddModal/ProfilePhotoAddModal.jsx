  ...
  return (
    createPortal(
      <dialog ref={dialogRef} className={styles.modal_dialog}>
        <button onClick={closeButton} className={styles.close_button}>X</button>
        {
          avatar ?
            <form className={styles.modal_avatar_block}>
              <img src={avatar} alt="" className={styles.modal_chosen_avatar}/>
              <button onClick={submitPhoto} className={styles.modal_avatar_button}>Подтвердить</button>
            </form>
            :
            <div className={styles.modal_content}>
              <label htmlFor="file" className={styles.modal_content_label}>
            <span>
              <img className={styles.modal_content_label_picture} src={photo} alt="Upload"/>
            </span>
                <p>Выберете файл формата <br/> jpeg или png</p>
              </label>
              <form>
                <input
